...
const Alohaking: React.FC = () => {
  const videoUrl = "https://demo.bgaming-network.com/games/AlohaKingElvis/FUN?play_token=b66e5709-22a7-4a1e-b055-996cb4c4ff1d";
              ...
              <div className="col-md-4">
                <a className="btn-game" href="#" onClick={toggleVideo}>
                  <div style={{ width: "250px", height: "250px", position: "relative", zIndex: "1" }}>
                    <img src="images/img/bgaming/alohakingelvis.png" alt="AlohaKing" />
