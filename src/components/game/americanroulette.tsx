...
const Americanroulette: React.FC = () => {
  const videoUrl = "https://demo.bgaming-network.com/games/AmericanRoulette/FUN?play_token=34dae45e-c109-462f-9ad2-3fc9fb0150b3";
              ...
              <div className="col-md-4">
                <a className="btn-game" href="#" onClick={toggleVideo}>
                  <div style={{ width: "250px", height: "250px", position: "relative", zIndex: "1" }}>
                    <img src="images/img/bgaming/americanroulette.png" alt="americanroulette" />
