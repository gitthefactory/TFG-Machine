...
//     e.preventDefault();
//     if (!info.nombreCompleto || !info.email || !info.password) {
...
//         form.reset();
//         router.push("/signin")
//         console.log("Usuario Registradoooo")
//       } else {
...
//               Desarrolla tu operación IGaming de la mano de un equipo enfocado en tu éxito.
//               </p>
